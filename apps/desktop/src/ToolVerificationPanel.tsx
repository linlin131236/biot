...
interface Props {
  fetcher?: Fetcher;
  api: {
    verifyTools: (fetcher: Fetcher) => Promise<Record<string, unknown>>;
  };
}
...
export function ToolVerificationPanel({ fetcher, api }: Props) {
  ...
  async function handleVerify() {
    ...
    setPhase('running');
    try {
      const res = await api.verifyTools(fetcher);
