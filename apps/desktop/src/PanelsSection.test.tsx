...
function apiFixture() {
  return {
    ...
    executionHandoff: { fetchExecutionHandoffs: vi.fn().mockResolvedValue([]), fetchExecutionAuditTimeline: vi.fn().mockResolvedValue([]), fetchExecutionAuditDiagnostics: vi.fn().mockResolvedValue([]), createExecutionHandoff: vi.fn(), completeExecutionHandoff: vi.fn(), failExecutionHandoff: vi.fn(), requestExecutionHandoffPermission: vi.fn() },
  };
}
